...
const PPL = {
  push: { label: "Push", ja: "プッシュ", desc: "胸・肩・三頭筋", color: "#f06060", bg: "#2a0a0a",
    exercises: ["ベンチプレス","インクラインプレス","チェストフライ","チェストプレス","インクラインチェストプレス","ペックフライ","ナロープレス","ショルダープレス","サイドレイズ","フロントレイズ","トライセップスプレスダウン","オーバーヘッドエクステンション","ディップス","ケーブルバイセップスカール"] },
...
const MUSCLE_MAP = {
  "ベンチプレス":"胸","インクラインプレス":"胸","チェストフライ":"胸","チェストプレス":"胸","インクラインチェストプレス":"胸","ペックフライ":"胸",
  "ショルダープレス":"肩","サイドレイズ":"肩","フロントレイズ":"肩",
  "ナロープレス":"三頭","トライセップスプレスダウン":"三頭","オーバーヘッドエクステンション":"三頭","ディップス":"三頭",
  "ラットプルダウン":"背中","マシンラットプルダウン":"背中","ナローラットプルダウン":"背中","シーテッドロウ":"背中","ベントオーバーロウ":"背中","ワンハンドロウ":"背中","フェイスプル":"背中","リアデルトフライ":"背中",
  "バイセップカール":"二頭","ハンマーカール":"二頭","インクラインカール":"二頭","ケーブルバイセップスカール":"二頭",
